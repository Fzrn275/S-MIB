...
const styles = StyleSheet.create({
  ...
  levelBadge: { color: colors.navy, backgroundColor: colors.cyan, fontSize: sizes.textXs, fontWeight: '900', paddingHorizontal: 8, paddingVertical: 2, borderRadius: radii.pill, overflow: 'hidden' },
